...
def open_imagen(ruta):
    try:
        ...
        # Muestra la imagen
        print(f"Imagen {ruta} abierta exitosamente.")
        imagen.show()
...
if __name__ == "__main__":
    ...
    if imagen:
        ...
        part_size = total_size // args.num_parts
        ...
        combined_image = combine_images(width, height, width_part, height_part, args.num_parts, shared_array)
        combined_image.show()
